...
# "DM_gravity"    "plant_type"    "branch_number" "root_type1_5" fitted in the model

for (var in trait_ideal_pivot[-c(2, 3, 5, 8)]) {
  trials <- resum_tables %>%
...
sapply(my_dat[trait_ideal_pivot[-c(2, 3, 5, 8)]], multiple.func)
```
...
res.pca <- pca_index(data = TestIndex_, id = "accession_name", b = c(-10, -10, 10, -10, 10), percentage = 0.20)
